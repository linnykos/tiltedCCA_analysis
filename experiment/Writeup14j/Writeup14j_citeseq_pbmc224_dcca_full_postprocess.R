rm(list=ls())
library(Seurat)
load("../../../../out/Writeup14j/Writeup14j_citeseq_pbmc224_dcca_full.RData")
dcca_res <- dcca_res2
...
for(i in 1:length(reduction_vec)){
  for(j in 1:length(group_vec)){
    ...
    ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14j/Writeup14j_citeseq_pbmc224_dcca_", file_vec[i], "3.png"),
