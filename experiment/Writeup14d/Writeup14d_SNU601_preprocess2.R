...
######## let's first try using the measured phi's and theta's
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14d/Writeup14d_SNU_measured_atac.png"),
...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14d/Writeup14d_SNU_measured_cna.png"),
                plot1, device = "png", width = 5, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14d/Writeup14d_SNU_measured_wnn.png"),
                plot1, device = "png", width = 5, height = 5, units = "in")
