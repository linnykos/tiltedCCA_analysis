rm(list=ls())
load("../../../../data/Pairedtag_mousebrain_RNA-Histone/preprocessed_H3K27me3.RData")
load("../../../../data/Pairedtag_mousebrain_RNA-Histone/seurat_H3K27me3.RData")
...
dat_1c <- multiomicCCA:::.mult_vec_mat(1/rowsum_vec*1e6, dat_1c)
center_vec <- sparseMatrixStats::colMeans2(dat_1c)
sd_vec <- sparseMatrixStats::colSds(dat_1c)
svd_res <- irlba::irlba(dat_1c, nv = 50, scale = sd_vec, center = center_vec)
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Paired-Tag: H3K27me3 (Histone)"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14d/Writeup14d_pairedtag_H3K27me3_histone.png"),
