...
set.seed(10)
mat <- SNU[["atac"]]@data[SNU[["atac"]]@var.features,]
svd_res <- irlba::irlba(mat, nv = 200)
...
for(group in group_vec){
  ...
  ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14e/Writeup14e_SNU_atac_exploration2_", group, ".png"),
