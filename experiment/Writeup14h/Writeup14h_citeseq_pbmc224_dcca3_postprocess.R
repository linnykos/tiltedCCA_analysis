rm(list=ls())
library(Seurat)
load("../../../../out/Writeup14h/Writeup14h_citeseq_pbmc_v3_dcca3.RData")
dcca_res$tilt_perc
dcca_res2$tilt_perc

png("../../../../out/figures/Writeup14h/Writeup14h_citeseq_pbmc_v3_dcca_scores.png",
...
png("../../../../out/figures/Writeup14h/Writeup14h_citeseq_pbmc_v3_cca_scores.png",
    height = 1200, width = 2500, units = "px", res = 300)
par(mfrow = c(1,3), mar = c(4,4,4,0.5))
...
png("../../../../out/figures/Writeup14h/Writeup14h_citeseq_pbmc_v3_svd.png",
    height = 1200, width = 2500, units = "px", res = 300)
par(mfrow = c(1,3), mar = c(4,4,4,0.5))
...
for(i in 1:length(reduction_vec)){
  for(j in 1:length(group_vec)){
    ...
    ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14h/Writeup14h_citeseq_pbmc_v3_", file_vec[i], ".png"),
