...
save(multiSVD_obj, mbrain,
     ...
     file = "../../../../out/Writeup14l/Writeup14l_10x_mouseembryo_tcca.RData")
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14l/Writeup14l_10x_mouseembryo_umap_common-tcca.png"),
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Mouse Embryo (10x, RNA+ATAC)\nDistinct 1 subspace"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14l/Writeup14l_10x_mouseembryo_umap_distinct1-tcca.png"),
                plot1, device = "png", width = 8, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Mouse Embryo (10x, RNA+ATAC)\nDistinct 2 subspace"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14l/Writeup14l_10x_mouseembryo_umap_distinct2-tcca.png"),
                plot1, device = "png", width = 8, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14l/Writeup14l_10x_mouseembryo_umap_rna_cell_alignment.png"),
