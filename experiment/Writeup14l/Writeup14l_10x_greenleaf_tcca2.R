...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14l/Writeup14l_10x_greenleaf2_umap_common-laplacian.png"),
...
save(multiSVD_obj, greenleaf,
     ...
     file = "../../../../out/Writeup14l/Writeup14l_10x_greenleaf2_tcca.RData")
