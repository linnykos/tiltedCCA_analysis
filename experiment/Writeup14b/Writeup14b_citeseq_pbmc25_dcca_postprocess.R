...
tmp <- multiomicCCA::plot_laplacian_variables(val_vec, name_vec, factor_vec, col_vec,
                                ...
                                text_cex = 4)
ggplot2::ggsave(filename = "../../../../out/figures/Writeup14b/Writeup14b_citeseq_bm25_rna_var_enrichment.png",
...
tmp <- multiomicCCA::plot_laplacian_variables(val_vec, name_vec, factor_vec, col_vec,
                                              ...
                                              text_cex = 4)
ggplot2::ggsave(filename = "../../../../out/figures/Writeup14b/Writeup14b_citeseq_bm25_protein_var_enrichment.png",
                tmp, device = "png", width = 3, height = 3, units = "in")
