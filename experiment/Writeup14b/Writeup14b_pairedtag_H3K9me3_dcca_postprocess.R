rm(list=ls())
load("../../../../out/Writeup14b/Writeup14b_pairedtag_H3K9me3_dcca.RData")
...
for(i in 1:3){
  ...
  ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K9me3_dcca_rna_", main_vec[i], "_umap.png"),
...
for(i in 1:3){
  ...
  plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
  ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K9me3_dcca_histone_", main_vec[i], "_umap.png"),
                  plot1, device = "png", width = 6, height = 5, units = "in")
}
...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K9me3_dcca_both_common_umap.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::ggtitle("Paired-Tag H3K9me3\nBoth Everything")
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K9me3_dcca_both_everything_umap.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")
