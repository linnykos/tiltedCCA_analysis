rm(list=ls())
load("../../../../out/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca.RData")
...
for(i in 1:3){
        ...
        ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_rna_", main_vec[i], "_umap.png"),
...
for(i in 1:3){
        ...
        plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
        ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_histone_", main_vec[i], "_umap.png"),
                        plot1, device = "png", width = 6, height = 5, units = "in")
}
...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_both_common_umap.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::ggtitle("Paired-Tag H3K4me1\nBoth Everything")
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_both_everything_umap.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_rna_common_basis.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_rna_distinct_basis.png"),
                plot1, device = "png", width = 16, height = 12, units = "in")

plot1 <- Seurat::FeaturePlot(pairedtag2, features = paste0("elap_", 1:16), reduction = "both")
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_rna_everything_basis.png"),
                plot1, device = "png", width = 16, height = 12, units = "in")

# next ATAC
plot1 <- Seurat::FeaturePlot(pairedtag2, features = paste0("clap2_", 1:16), reduction = "combined")
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_atac_common_basis.png"),
                plot1, device = "png", width = 16, height = 12, units = "in")

plot1 <- Seurat::FeaturePlot(pairedtag2, features = paste0("dlap2_", 1:16), reduction = "distinct2")
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_atac_distinct_basis.png"),
                plot1, device = "png", width = 16, height = 12, units = "in")

plot1 <- Seurat::FeaturePlot(pairedtag2, features = paste0("elap2_", 1:16), reduction = "both")
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_dcca_atac_everything_basis.png"),
                plot1, device = "png", width = 16, height = 12, units = "in")
...
cowplot::save_plot(filename = "../../../../out/figures/Writeup14b/Writeup14b_pairedtag_H3K4me1_enrichment.png", 
