...
for(j in 1:p){
  if(j > 10 & j %% floor(p/10) == 0) {
    save(rna_common, predicted_list, 
         file = "../../../../out/Writeup14o/Writeup14o_10x_greenleaf_timeseries_npregfast_tmp.RData")
  }
  print(j)
...
save(greenleaf, multiSVD_obj, rna_common, predicted_list, 
     ...
     file = "../../../../out/Writeup14o/Writeup14o_10x_greenleaf_timeseries_npregfast.RData")

# png(paste0("../../../../out/figures/Writeup14o/Writeup14o_10x_greenleaf_timeseries_npregfast.png"),
...
#   lines(x = predicted_list[[j]][,1], y = predicted_list[[j]][,2], col = "white", lwd = 4)
#   lines(x = predicted_list[[j]][,1], y = predicted_list[[j]][,2], col = 2, lwd = 2)
# }
# graphics.off()
