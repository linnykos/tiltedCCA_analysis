...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14p/Writeup14p_10x_reik_umap_common-laplacian_v2.png"),
...
save(multiSVD_obj, reik, peak_granges,
     ...
     file = "../../../../out/Writeup14p/Writeup14p_10x_reik_tiltedcca_v2.RData")
