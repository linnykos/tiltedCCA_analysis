...
for(j in 1:nrow(param_df)){
  ...
  tmp <- greenleaf; tmp_mat <- tmp_obj$laplacian_list$common_laplacian
  ...
  ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/10x_greenleaf_laplacian-", j, ".png"),
  ...
  png(paste0("../../../../out/figures/Writeup14n/10x_greenleaf_laplacian_heatmap-", j, ".png"),
