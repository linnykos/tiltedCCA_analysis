...
load("../../../../out/Writeup14n/abseq_bm97Ref_distinct_differential.RData")
...
save(variable_selection_res, bm, 
     ...
     file = "../../../../out/Writeup14n/abseq_bm97Ref_varSelect.RData")
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/abseq_bm97Ref_varSelect_adt-umap.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/abseq_bm97Ref_varSelect_consensusPCA-umap.png"),
