rm(list=ls())
load("../../../../out/Writeup14n/citeseq_pbmc224_tiltedcca.RData")
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/citeseq_pbmc224_tcca-umap_common.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/citeseq_pbmc224_tcca-umap_distinct1.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/citeseq_pbmc224_tcca-umap_distinct2.png"),
