...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/10x_greenleaf_tcca_RNA-ATAC_umap_common.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/10x_greenleaf_tcca_RNA-ATAC_umap_distinct1.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/10x_greenleaf_tcca_RNA-ATAC_umap_distinct2.png"),
