...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/10x_greenleaf_umap_RNA-ATAC_common-laplacian.png"),
...
save(multiSVD_obj, greenleaf,
     ...
     file = "../../../../out/Writeup14n/10x_greenleaf_tcca_RNA-ATAC.RData")
