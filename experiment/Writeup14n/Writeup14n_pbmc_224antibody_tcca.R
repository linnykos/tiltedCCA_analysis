...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/citeseq_pbmc224_subset_rna-umap.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
plot1 <- Seurat::DimPlot(pbmc, reduction = "rna.umap",
                         group.by = "SCT_snn_res.0.1", label = TRUE,
                         repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("PBMC (CITE-Seq, RNA+224 ADT)\nSubset, RNA clustering"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/citeseq_pbmc224_subset_rna-clustering.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("PBMC (CITE-Seq, RNA+224 ADT)\nSubset, ADT UMAP"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/citeseq_pbmc224_subset_adt-umap.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
plot1 <- Seurat::DimPlot(pbmc, reduction = "adt.umap",
                         group.by = "ADT_snn_res.0.1", label = TRUE,
                         repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("PBMC (CITE-Seq, RNA+224 ADT)\nSubset, ADT clustering"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup14n/citeseq_pbmc224_subset_adt-clustering.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
...
multiSVD_obj <- tiltedCCA:::form_metacells(input_obj = multiSVD_obj,
                                           large_clustering_1 = as.factor(pbmc$SCT_snn_res.0.1), 
                                           large_clustering_2 = as.factor(pbmc$ADT_snn_res.0.1), 
                                           num_metacells = 5000,
                                           verbose = 1)
...
save(multiSVD_obj, pbmc,
     ...
     file = "../../../../out/Writeup14n/citeseq_pbmc224_tiltedcca.RData")
