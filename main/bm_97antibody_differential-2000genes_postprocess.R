...
load("../../../out/main/abseq_bm97_tcca-2000genes.RData")
...
png("../../../out/figures/main/abseq_bm97-2000genes_differential_gene.png",
...
png("../../../out/figures/main/abseq_bm97-2000genes_differential_gene-colored.png",
    height = 3500, width = 2500, res = 500, units = "px")
# par(mar = c(5,5,4,1), bg = NA)
par(mar = c(5,5,4,1))
...
png("../../../out/figures/main/abseq_bm97-2000genes_differential_gene_Cell_cycle.png",
    height = 3500, width = 2500, res = 500, units = "px")
# par(mar = c(5,5,4,1), bg = NA)
par(mar = c(5,5,4,1))
tiltedCCA:::plot_alignment(rsquare_vec = rsquare_vec,
...
png("../../../out/figures/main/abseq_bm97-2000genes_differential_adt.png",
    height = 3500, width = 2500, res = 500, units = "px")
# par(mar = c(5,5,4,1), bg = NA)
par(mar = c(5,5,4,1))
tiltedCCA:::plot_alignment(rsquare_vec = adt_rsquare_vec,
                           ...
                           bool_mark_ymedian = T,
                           col_gene_highlight_border = rgb(255, 205, 87, 255*0.5, maxColorValue = 255),
                           col_points = rgb(0.6, 0.6, 0.6, 0.5),
                           cex_axis = 1.5, 
                           cex_lab = 1.5,
                           cex_points = 2.5,
                           lty_polygon = 2,
