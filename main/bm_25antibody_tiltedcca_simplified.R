...
n <- ncol(bm)
celltype_vec <- c("CD14 Mono", "cDC2", "Prog_DC", "GMP", "LMPP",
                  "Prog_B 1", "Prog_B 2", "Naive B", "CD4 Naive", "CD8 Naive",
                  "CD4 Memory", "CD8 Memory_1")
keep_vec <- rep(0, n)
keep_vec[which(bm$celltype.l2 %in% celltype_vec)] <- 1
bm$keep <- keep_vec
bm <- subset(bm, keep == 1)
...
bm <- Seurat::FindClusters(bm, resolution = 0.15)
...
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_bm25_simplified_rna-umap.png"),
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Human BM (CITE-Seq, RNA+ADT)\nRNA clustering"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_bm25_simplified_rna-clustering.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Human BM (CITE-Seq, RNA+ADT)\nADT UMAP"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_bm25_simplified_adt-umap.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
plot1 <-Seurat::DimPlot(bm, reduction = "adt.umap",
                        group.by = "ADT_snn_res.0.15", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("Human BM (CITE-Seq, RNA+ADT)\nADT clustering"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_bm25_simplified_adt-clustering.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
...
multiSVD_obj <- tiltedCCA:::form_metacells(input_obj = multiSVD_obj,
                                           ...
                                           large_clustering_2 = as.factor(bm$ADT_snn_res.0.15), 
                                           num_metacells = 5000,
                                           verbose = 1)
...
save(multiSVD_obj, bm,
     ...
     file = "../../../out/main/citeseq_bm25_simplified.RData")
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Human BM (CITE-Seq, RNA+ADT)\nCommon subspace"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_bm25_simplified_tcca-umap_common.png"),
...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_bm25_simplified_tcca-umap_distinct1.png"),
                plot1, device = "png", width = 5.5, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_bm25_simplified_tcca-umap_distinct2.png"),
                plot1, device = "png", width = 5.5, height = 5, units = "in")
