...
gene_depth <- log10(Matrix::rowSums(bm[["RNA"]]@counts[names(rsquare_vec),])+1)
...
png("../../../out/figures/main/abseq_bm97_differential_gene-colored.png",
    height = 3500, width = 2500, res = 500, units = "px")
# par(mar = c(5,5,4,1), bg = NA)
par(mar = c(5,5,4,1))
...
png("../../../out/figures/main/abseq_bm97_differential_gene_Cell_cycle.png",
    height = 3500, width = 2500, res = 500, units = "px")
# par(mar = c(5,5,4,1), bg = NA)
par(mar = c(5,5,4,1))
tiltedCCA:::plot_alignment(rsquare_vec = rsquare_vec,
...
png("../../../out/figures/main/abseq_bm97_differential_adt.png",
    height = 3500, width = 2500, res = 500, units = "px")
# par(mar = c(5,5,4,1), bg = NA)
par(mar = c(5,5,4,1))
