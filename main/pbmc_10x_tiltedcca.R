...
set.seed(10)
pbmc <- Seurat::FindNeighbors(pbmc, dims = 1:50, reduction = "lsi")
pbmc <- Seurat::FindClusters(pbmc, resolution = 0.25)
...
ggplot2::ggsave(filename = paste0("../../../out/figures/main/10x_pbmc_rna-clustering.png"),
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("PBMC (10x, RNA+ATAC)\nATAC clustering"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/10x_pbmc_atac-clustering.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
...
save(multiSVD_obj, pbmc,
     ...
     file = "../../../out/main/10x_pbmc_tiltedcca.RData")
