...
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_pbmc224-2000genes_rna-umap.png"),
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("PBMC (CITE-Seq, RNA+224 ADT)\nSubset, RNA clustering"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/citeseq_pbmc224-2000genes_rna-clustering.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
...
save(multiSVD_obj, pbmc,
     ...
     file = "../../../out/main/citeseq_pbmc224_tiltedcca-2000genes.RData")
