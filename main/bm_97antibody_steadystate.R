...
png(paste0("../../../out/figures/main/abseq_bm97_tcca_steadystate-full.png"),
...
png(paste0("../../../out/figures/main/abseq_bm97_tcca_steadystate_alt-full.png"),
    height = 3000, width = 3000, units = "px", res = 500)
par(mar = c(4,4,4,0.5))
plot(x = bm[["common_tcca"]]@cell.embeddings[,1],
     y = bm[["common_tcca"]]@cell.embeddings[,2],
