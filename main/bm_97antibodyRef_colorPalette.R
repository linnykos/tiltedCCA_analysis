col_palette <- c(
  "Aberrant erythroid" = rgb(255, 205, 114, maxColorValue = 255), 
  "CD11c+ memory B cells" = rgb(149, 167, 186, maxColorValue = 255),
  "CD4+ cytotoxic T cells" = rgb(119, 56, 158, maxColorValue = 255),
  ...
  "CD69+PD-1+ memory CD4+ T cells" = rgb(234, 195, 240, maxColorValue = 255), # only 52
  ...
  "Mesenchymal cells_1" = rgb(118, 249, 77, maxColorValue = 255), # only 17
  "Mesenchymal cells_2" = rgb(235, 59, 146, maxColorValue = 255), # only 1
  "Monocyte-like blasts" = rgb(164, 202, 79, maxColorValue = 255), # only 2
  "Myelocytes" = rgb(89, 166, 69, maxColorValue = 255),
  "NK cell progenitors" = rgb(181, 159, 196, maxColorValue = 255),   # only 26
  "NK T cells" = rgb(199, 188, 225, maxColorValue = 255),
  ...
  "Pre-pro-B cells" = rgb(37, 79, 245, maxColorValue = 255),  # only 17
  "Pro-B cells" = rgb(25, 72, 233, maxColorValue = 255),
  "Small pre-B cell" = rgb(37, 37, 203, maxColorValue = 255) # only 4
)
