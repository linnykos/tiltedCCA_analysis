...
ggplot2::ggsave(filename = paste0("../../../out/figures/main/abseq_bm97Ref_rna-clustering.png"),
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Human BM (Abseq, RNA+ADT)\nADT clustering"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/abseq_bm97Ref_adt-clustering.png"),
                plot1, device = "png", width = 6.5, height = 5, units = "in")
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("Human BM (Abseq, RNA+ADT)\nCommon Laplacian"))
plot1 <- plot1 + ggplot2::theme(legend.text = ggplot2::element_text(size = 5))
ggplot2::ggsave(filename = paste0("../../../out/figures/main/abseq_bm97Ref_common-laplacian.png"),
...
save(multiSVD_obj, bm,
     ...
     file = "../../../out/main/abseq_bm97Ref_tcca.RData")
