...
png("../tiltedCCA/vignettes/simulation1_data.png", height = 1200, width = 2000, res = 300, units = "px")
par(mfrow = c(1,2))
tmp <- svd_func(mat_1)
...
png("../tiltedCCA/vignettes/simulation1_tcca.png", height = height, width = 3000/1200*height, res = 300, units = "px")
par(mfrow = c(1,3))
...
png("../tiltedCCA/vignettes/simulation1_consensuspca.png", height = 1200, width = 1000, res = 300, units = "px")
par(mfrow = c(1,1))
