...
col_vec <- c(orange_col, green_col, blue_col, black_col, purple_col)
...
png("../tiltedCCA/vignettes/simulation2_data.png", height = 1200, width = 2000, res = 300, units = "px")
par(mfrow = c(1,2))
...
png("../tiltedCCA/vignettes/simulation2_tcca.png", height = height, width = 3000/1200*height, res = 300, units = "px")
par(mfrow = c(1,3))
...
png("../tiltedCCA/vignettes/simulation2_consensuspca.png", height = 1200, width = 1000, res = 300, units = "px")
par(mfrow = c(1,1))
